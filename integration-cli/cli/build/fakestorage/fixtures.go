package fakestorage // import "github.com/tiborvass/docker/integration-cli/cli/build/fakestorage"
...
func ensureHTTPServerImage(t testingT) {
	...
	if _, err = os.Stat("../contrib/httpserver/httpserver"); os.IsNotExist(err) {
		...
		cmd := exec.Command(goCmd, "build", "-o", filepath.Join(tmp, "httpserver"), "github.com/tiborvass/docker/contrib/httpserver")
