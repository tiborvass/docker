...
func (pr *pluginRouter) installPlugin(ctx context.Context, w http.ResponseWriter, r *http.Request, vars map[string]string) error {
	...
	return pr.backend.Install(vars["name"], metaHeaders, authConfig)
}
...
func (pr *pluginRouter) setPlugin(ctx context.Context, w http.ResponseWriter, r *http.Request, vars map[string]string) error {
	return pr.backend.Set(vars["name"], strings.Fields(vars["settings"]))
}
