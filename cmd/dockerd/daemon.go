...
import (
	...
	distributionrouter "github.com/tiborvass/docker/api/server/router/distribution"
	grpcrouter "github.com/tiborvass/docker/api/server/router/grpc"
	...
	sessionrouter "github.com/tiborvass/docker/api/server/router/session"
